...
registry.category("web_tour.tours").add("test_picking_kit_variant_packaging", {
    steps: () => [
        ...
        {
            trigger: ".o_barcode_line:contains('Compo 01') .o_add_quantity",
            run: "click",
        },
        {
            trigger: ".o_barcode_line:contains('Compo 02') .o_add_quantity",
            run: "click",
        },
        {
            trigger: ".o_validate_page",
        ...
        {
            trigger: ".o_notification:contains('The transfer has been validated')",
            run() {},
        },
    ],
});
